 ...
 */
export function frontDownload(filePath: string, fileName: string): void {
 ...
 *
 * @export
 * @param {Blob} downloadRes - 二进制文件数据
 * @param {string} fileName - 下载的文件名
 */
export function downloadByBinary(downloadRes: Blob, fileName: string): void {
 ...
 *
 * @export
 * @param {string} base64str - base64编码的文件内容
 * @param {string} fileName - 下载的文件名
 */
export function downloadByBase64(base64str: string, fileName: string): void {
