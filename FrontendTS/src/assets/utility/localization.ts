...
function initDictionary() {
  getLanguages().then((x) => {
    ...
    translate.setLocaleMessage('es', x.es);
    translate.setLocaleMessage('pt', x.pt);
  });
}
...
function initLoginDictionary() {
  ...
  translate.setLocaleMessage('de', {
    ...
    验证码: 'Captcha',
    本系统由天津水泥工业设计研究院有限公司数字化研究所研发和运维:
      'Diese Plattform wird entwickelt und gewartet vom Digital Research Institute der TCDRI Co., Ltd.',
  });
  ...
  translate.setLocaleMessage('es', {
    ...
    验证码: 'Captcha',
    本系统由天津水泥工业设计研究院有限公司数字化研究所研发和运维:
      'Esta plataforma es desarrollada y mantenida por el Digital Research Institute de TCDRI.',
  });
  translate.setLocaleMessage('pt', {
    欢迎来到: 'Bem-vindo a',
    登录: 'Entrar',
    登录中: 'Entrando...',
    登录失败: 'Falha no login',
    请输入: 'Por favor, digite',
    账号禁用: 'Conta desativada',
    验证码错误: 'Erro de captcha',
    ...
    验证码: 'Captcha',
    本系统由天津水泥工业设计研究院有限公司数字化研究所研发和运维:
      'Esta plataforma foi desenvolvida e mantida por TCDRI Digital Research Institute.',
  });
}
