...
<template>
  <div class="container" style="text-align: center">
    <NFlex vertical :size="3">
      <button
        :disabled="typeof inPara.method !== 'function' || inPara.forbidden"
        class="water-btn"
        :style="{
          color: dataColor(),
      ...
      <div style="color: #fff; transform: translateY(-5px); font-size: 13px">{{ inPara.name }}</div>
    </NFlex>
  </div>
</template>
<style scoped>
